...
BUILD_JOBS=${OLLAMA_BUILD_JOBS:-$(nproc --all 2>/dev/null || getconf _NPROCESSORS_ONLN 2>/dev/null || nproc)}
BUILD_ARGS="$BUILD_ARGS --build-arg=OLLAMA_BUILD_JOBS=$BUILD_JOBS"
